...
@PropertySources({
    ...
    @PropertySource(value = "classpath:mail/mail-${spring.profiles.active:default}.properties", ignoreResourceNotFound = true)
})
...
public class MailConfig {
  ...
  @NotNull JavaxMailService mailService() {
    ...
    JavaxMailSender.JavaxMailSenderConfig javaxConfig = JavaxMailSender.JavaxMailSenderConfig
        .builder()
