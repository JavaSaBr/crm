...
import static crm.client.web.exception.ClientErrors.CLIENT_ASSIGNER_NOT_PRESENTED
import static crm.client.web.exception.ClientErrors.CLIENT_ASSIGNER_NOT_PRESENTED_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_BIRTHDAY_INVALID
import static crm.client.web.exception.ClientErrors.CLIENT_BIRTHDAY_INVALID_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_COMPANY_TOO_LONG
import static crm.client.web.exception.ClientErrors.CLIENT_COMPANY_TOO_LONG_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_EMAIL_INVALID
import static crm.client.web.exception.ClientErrors.CLIENT_EMAIL_INVALID_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_FIRST_NAME_INVALID_LENGTH
import static crm.client.web.exception.ClientErrors.CLIENT_FIRST_NAME_INVALID_LENGTH_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_MESSENGER_INVALID
import static crm.client.web.exception.ClientErrors.CLIENT_MESSENGER_INVALID_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_PHONE_NUMBER_INVALID
import static crm.client.web.exception.ClientErrors.CLIENT_PHONE_NUMBER_INVALID_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_SECOND_NAME_INVALID_LENGTH
import static crm.client.web.exception.ClientErrors.CLIENT_SECOND_NAME_INVALID_LENGTH_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_SITE_INVALID
import static crm.client.web.exception.ClientErrors.CLIENT_SITE_INVALID_MESSAGE
import static crm.client.web.exception.ClientErrors.CLIENT_THIRD_NAME_TOO_LONG
import static crm.client.web.exception.ClientErrors.CLIENT_THIRD_NAME_TOO_LONG_MESSAGE
import static crm.client.web.exception.ClientErrors.INVALID_ASSIGNER
import static crm.client.web.exception.ClientErrors.INVALID_ASSIGNER_MESSAGE
