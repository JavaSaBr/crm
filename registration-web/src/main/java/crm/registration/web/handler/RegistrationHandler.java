...
import crm.registration.web.resources.UserRegisterInResource;
...
public class RegistrationHandler {
  ...
  @NotNull CompletableFuture<?> register(
      @RequestHeader("token") @NotNull String token, @NotNull @RequestBody UserRegisterInResource resource) {
