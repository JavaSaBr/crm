package crm.dictionary.web.resource;
...
public record CountryOutResource(
    ...
    @NotNull String phoneCode) implements RestResource {

  public static @NotNull CountryOutResource from(@NotNull Country country) {
    return new CountryOutResource(country.id(), country.name(), country.flagCode(), country.phoneCode());
  }
}
